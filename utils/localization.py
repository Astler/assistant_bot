strings = {
    ...
    "ru": {
        ...
        "announce_2": "<b>Общаемся на тему программирования и всего что с ним связано 👊</b>\n\n🕒 Все стикеры и медиа временно запрещены\n🤬 Ненормативная лексика запрещена\n👽 Оффтоп наказывается мутами\n\n<b>Приятного общения 🥰</b>",
        "announce_3": "<b>#оставайтесьдома 👾 играйте в игры, 👽 смотрите фильмы, 😴 больше отдыхайте.</b>\n\n✌️ "
                      "Будьте здоровы ",

        "can_be_used_with_reply": "Можно использовать только как ответ на сообщение",
        "this_command_only_for_admins": "Эту команду могут использовать только админы!",
        "ro_in_personal_messages": "Тут некого банить!",
    },
}
